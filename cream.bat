...
for /f "usebackq delims=" %%i in ("%CREAM_HOME%cp.txt") do set "CP=%%i"

java -Dfile.encoding=UTF-8 -Dsun.stdout.encoding=UTF-8 -Dsun.stderr.encoding=UTF-8 --enable-native-access=ALL-UNNAMED -cp "%CREAM_HOME%target\classes;%CP%" cream.cli.Client %*
